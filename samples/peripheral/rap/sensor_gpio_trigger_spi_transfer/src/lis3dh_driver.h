...
/* SPI Specific Bits */
#define LIS3DH_SPI_RW_BIT               (1 << 7)
#define LIS3DH_SPI_MS_BIT               (1 << 6)
 ...
 * \param  spi_dev: SPI Peripheral instance.
 */
...
/**
 * \brief  Configure Burst Read for SPI.
 *         Note: This only configures the SPI Protocol (NDF, RAP Mode).
 *         The Application is responsible for setting up DMA TX/RX.
 */
